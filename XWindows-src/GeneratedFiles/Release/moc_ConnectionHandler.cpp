...
QT_MOC_LITERAL(3, 32, 18) // "maintainConnection"

    },
    "ConnectionHandler\0stateChanged\0\0"
    "maintainConnection"
};
...
void ConnectionHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stateChanged((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 1: _t->maintainConnection(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ConnectionHandler::*)(const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionHandler::stateChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConnectionHandler::stateChanged(const int _t1)
{
